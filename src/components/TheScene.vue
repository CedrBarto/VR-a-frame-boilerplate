...
<template>
  ...
  >
   ...
   <a-assets @loaded="allAssetsLoaded = true"> 
        <img id="sky-texture" :src="`assets/background/kloofendal_48d_partly_cloudy_puresky.jpg`"/>
      <a-asset-item id="lawnmower" :src="`assets/Model/hello_neighbor_2_alpha_2_lawnmower.glb`"></a-asset-item>

      </a-assets> 

    <!-- Sol simple de référence -->
    <a-plane color="lightgreen" width="6" height="6" rotation="-90 0 0" position="0 0 -1.5"></a-plane>

    <template v-if="allAssetsLoaded">
      <!-- <TheMainRoom :scale="scale" />
      <a-entity data-role="nav-mesh">
      <a-plane width="4" height="4" rotation="-90 0 0" position="0 0.1 -1"></a-plane>
      </a-entity>
      <Ground />
      <a-sky :src="`#sky-texture`"></a-sky> -->

      <!-- Lawnmower avec hitbox -->
      <a-entity 
